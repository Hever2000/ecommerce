...
Secrets stored in `backend/.env` (gitignored). Example file in `.env.example`.
...
- Currently implemented for manual logging — production should use interceptors or middleware for automatic coverage
